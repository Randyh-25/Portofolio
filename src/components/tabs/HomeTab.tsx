...
export const HomeTab = ({ profile, links, onNavigateToProfile }: HomeTabProps) => {
  return (
    <div
      ...
      className="w-full min-h-screen flex items-center justify-center px-3 sm:px-6 lg:px-8 py-12 sm:py-16"
    >
      <div className="max-w-6xl w-full space-y-8 sm:space-y-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-5 sm:space-y-6">
            <div className="backdrop-blur-xl bg-white/10 border border-white/20 rounded-2xl p-6 sm:p-8 shadow-xl hover:bg-white/15 transition-all duration-300 space-y-6">
              <div>
              ...
              <div className="pt-4 border-t border-white/10">
                <p className="font-heading text-sm sm:text-base text-white/70 mb-3">Connect with me</p>
                <div className="flex gap-3">
                  <a 
                    href={links.github} 
                    target="_blank" 
                    rel="noopener noreferrer" 
                    className="p-3 rounded-lg bg-white/10 border border-white/20 text-white hover:bg-white/20 hover:border-secondary/50 hover:scale-110 transition-all duration-300 group"
                    aria-label="Visit GitHub profile"
                  >
                    <Github size={20} className="group-hover:text-secondary transition-colors" />
                  </a>
                  <a 
                    href={links.linkedin} 
                    target="_blank" 
                    rel="noopener noreferrer" 
                    className="p-3 rounded-lg bg-white/10 border border-white/20 text-white hover:bg-white/20 hover:border-accent/50 hover:scale-110 transition-all duration-300 group"
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
              <button
                ...
                className="inline-flex items-center justify-center gap-2 px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-accent to-secondary text-gray-900 font-body font-semibold rounded-xl hover:shadow-lg hover:shadow-accent/50 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-accent focus:ring-offset-2 focus:ring-offset-gray-900 text-sm sm:text-base"
